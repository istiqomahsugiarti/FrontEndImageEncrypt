    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#e0e7ff] via-[#f1f5ff] to-[#f8fafc] px-4">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center z-10 relative">
          ...
          />
          <h1 className="text-3xl font-extrabold mb-1 text-[#4880FF] tracking-tight drop-shadow-sm">Daftar Akun</h1>
          <p className="text-slate-500 mb-6 text-center text-sm">Buat akun <span className="font-semibold text-[#4880FF]">Picrypt</span> untuk mulai mengamankan file Anda</p>
        </div>
        ...
        <div className="mt-6 text-center z-10 relative">
          ...
          >
            Sudah punya akun? <span className="underline">Login disini</span>
          </a>
        </div>
        {/* Footer kecil */}
